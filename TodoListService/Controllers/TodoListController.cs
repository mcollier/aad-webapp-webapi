...
namespace TodoListService.Controllers
{
    ...
    public class TodoListController : ApiController
    {
        ...
        private const string OwnerId = "B828255E-8A16-43D8-9A26-49AFD633A93C";
        ...
        public IEnumerable<TodoItem> Get()
        {
            ...
            Trace.TraceInformation("==> I was called by {0}.", ClaimsPrincipal.Current.FindFirst(ClaimTypes.Upn));
